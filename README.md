...
| **[Day 9 - Pangenomics](lessons/9-pangenomics.md)** | 2026/07/14 | Build pangenome graphs with PGGB, then inspect and manipulate graphs with ODGI<br>[Hackathon brief](lessons/9-pangenomics-hackathon.md) | Review lessons 7-8 |
| **[Day 10 - Pangenomics variant calling](lessons/10-pangenomics-variantcalling.md)** | 2026/07/15 | Use VG to index pangenome graphs, deconstruct graph variation, map reads, and call graph-supported variants<br>[Hackathon brief](lessons/10-pangenomics-variantcalling-hackathon.md) | Complete lesson 9 |
