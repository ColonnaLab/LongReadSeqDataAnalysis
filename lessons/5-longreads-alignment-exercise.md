...
user1@vm-corso-colonna:/data/user1/lr-working$ ls data-longreads/fastq/
user1@vm-corso-colonna:/data/user1/lr-working$ ls data-longreads/reference/
```

Create folders for the alignment results:

```bash
user1@vm-corso-colonna:/data/user1/lr-working$ mkdir -p alignment sam bam coverage
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ head data-longreads/reference/KUN1163_reference.fasta
user1@vm-corso-colonna:/data/user1/lr-working$ grep ">" data-longreads/reference/KUN1163_reference.fasta
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ minimap2 --help | less
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ ls -lh sam/
user1@vm-corso-colonna:/data/user1/lr-working$ head -5 sam/DRR187567.KUN1163.sam
user1@vm-corso-colonna:/data/user1/lr-working$ less -S sam/DRR187567.KUN1163.sam
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ samtools view \
  -b \
  sam/DRR187567.KUN1163.sam \
...
### **5. (optional) Faster Alternative: Pipe minimap2 into samtools**
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ samtools index bam/DRR187567.KUN1163.minimap2.sorted.bam
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ samtools flagstat \
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ cat alignment/DRR187567.flagstat.txt
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ samtools idxstats \
  bam/DRR187567.KUN1163.sorted.bam \
  > alignment/DRR187567.idxstats.txt
```

```bash
user1@vm-corso-colonna:/data/user1/lr-working$ cat alignment/DRR187567.idxstats.txt
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ ls -lh alignment/DRR187567.unmapped*
```
...
```bash
user1@vm-corso-colonna:/data/user1/lr-working$ cat coverage/DRR187567.coverage.txt
```
